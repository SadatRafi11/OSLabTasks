...
bool compare_burst(struct process x, struct process y) {
    return (int)x.burstTime <= (int)y.burstTime;
}
...
void preemptive_sjf_calculation() {
    int cnt = 0;
    string prev_name = "";
    while (true) {
        bool flag = false;
